...
const STORAGE_KEY = 'railsketch.lang';
...
const DICT = {
  pl: {
    ...
    'app.title': 'RailSketch – makiety H0 (PIKO A-Gleis)',
    ...
    'tab.piko': 'Tory', 'tab.accessory': 'Akcesoria', 'tab.scenery': 'Sceneria', 'port.generic': 'port {i}',
  ...
  en: {
    ...
    'app.title': 'RailSketch – H0 track planner (PIKO A-Gleis)',
    ...
    'tab.piko': 'Track', 'tab.accessory': 'Accessories', 'tab.scenery': 'Scenery', 'port.generic': 'port {i}',
  ...
  de: {
    ...
    'app.title': 'RailSketch – H0-Gleisplaner (PIKO A-Gleis)',
    ...
    'tab.piko': 'Gleise', 'tab.accessory': 'Zubehör', 'tab.scenery': 'Landschaft', 'port.generic': 'Anschluss {i}',
