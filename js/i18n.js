...
const DICT = {
  pl: {
    ...
    'draw.fix': 'Poprawiaj rysunek', 'draw.fixTitle': 'Włączone: proste są prostowane, a kąty i promienie dopasowywane do elementów PIKO (np. 7° → 7,5°). Wyłączone: tor podąża za kreską dosłownie.',
  ...
  en: {
    ...
    'draw.fix': 'Tidy up drawing', 'draw.fixTitle': 'On: straights are straightened and angles/radii snapped to PIKO pieces (e.g. 7° → 7.5°). Off: the track follows the stroke literally.',
  ...
  de: {
    ...
    'draw.fix': 'Zeichnung begradigen', 'draw.fixTitle': 'Ein: Geraden werden begradigt, Winkel und Radien auf PIKO-Gleise gerundet (z. B. 7° → 7,5°). Aus: das Gleis folgt dem Strich wörtlich.',
